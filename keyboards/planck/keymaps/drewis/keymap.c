...
[0] = LAYOUT_planck_grid( /* Base */
		...
		KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,  KC_B,   KC_M,   KC_W,   KC_V,  KC_Z,   KC_RSFT,
	        KC_FUNC, KC_DEL,  KC_LALT, KC_LGUI, KC_SPC,  RAISE, LOWER,  KC_ENT, KC_LEFT,KC_DOWN,KC_UP, KC_RIGHT),
/* Raise
 * ,-----------------------------------------------------------------------------------.
 ...
 * `-----------------------------------------------------------------------------------'
 */
[1] = LAYOUT_planck_grid( /* L1 */
		KC_GRV ,_______,_______,_______,_______,_______,_______,KC_RBRC,KC_LBRC,_______,KC_QUES, _______,
