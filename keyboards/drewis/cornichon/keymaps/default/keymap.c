...
[0] = LAYOUT( /* Base */
  ...
  KC_SCLN, KC_Q,    KC_J,    KC_K,   KC_X,   KC_B,   KC_M,   KC_W,   KC_V,   KC_Z,
           DEL_ALT, KC_SPC,  MO(1),  KC_LSFT,KC_RSFT,MO(2),  KC_ENT, MIN_CTL
  ),
/* Raise
 * ,---------------------------------------------------------------------.
 * |   `  |      |      |      |      |      |   [  |   ]  |   =  |   ?  |
...
//  _____, _____,   _____,     _____,   KC_TAB,  _____, _____,  _____, _____,       BSLS_CTL
  _____,                                                                           _____,
  KC_GRV,  _____,   _____,  _____,     _____,   _____,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,
  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
  C_Z,     C_X,     C_C,     C_V,     C_A,     KC_EXLM, KC_EQL,  _____,   KC_LBRC, KC_RBRC,
...
//  _____, _____,   _____,     _____,   KC_TAB,  _____,  _____,   _____, _____,     PIPE_CTL
  _____,                                                                          _____,
  KC_TILD, _____,   _____,   _____,    _____,   _____,   KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT,
  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,KC_LPRN, KC_RPRN,
  C_Z,     C_X,     C_C,     C_V,     C_A,     KC_PLUS, KC_EQL,  _____,  KC_LCBR, KC_RCBR,
           _____,   _____,   _____,   _____,   _____,   _____,   _____,  _____
		)
