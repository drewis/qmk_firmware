/* Copyright 2020 Andrew Sutherland (git@drewis.fun)
 *
...
[0] = LAYOUT( /* Base */
		...
		KC_TAB,   KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    ALTAB,   KC_ENT, FUNC1,   KC_NO,  KC_NO,   KC_NO,  KC_D,   KC_H,    KC_T,    KC_N,   KC_S,    KC_BSPC,
		CTL_ESC,  KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,                                                       KC_B,   KC_M,    KC_W,    KC_V,   KC_Z,    KC_MINS,
...
[1] = LAYOUT( /* L1 */
		...
		KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   MYKEY1, MYKEY2, MYKEY3 ,_______,_______,_______,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   _______,
		_______,C_Z,    C_X,    C_C,    C_V,    C_A,                                                    KC_PLUS,KC_EQL, _______,KC_LBRC,KC_RBRC,KC_PIPE,
...
[2] = LAYOUT( /* L2 */
		...
		_______,_______,_______,_______,_______,_______,                                                KC_EXLM,KC_EQL, _______,KC_LCBR,KC_RCBR,KC_BSLS,
		        _______,_______,_______,_______,        _______,_______,_______,_______,_______,_______,        KC_HOME,KC_PGDN,KC_PGUP,KC_END),
/*
