...
[0] = LAYOUT( /* Base */
		...
		KC_LEFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,                      KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RIGHT,
	                          KC_LALT, KC_LGUI, KC_SPC,  RAISE,   KC_LSFT, KC_RSFT, LOWER,   KC_ENT,  KC_DOWN, KC_UP),
/*
 * Raise
 */
[1] = LAYOUT( /* L1 */
		_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
		KC_GRV ,KC_LEFT,KC_DOWN,KC_UP,  KC_RIGHT,KC_DEL,                _______,_______,_______,_______,KC_QUES,_______,
...
[2] = LAYOUT( /* L2 */
		_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
		KC_TILD,_______,_______,_______,_______,_______,                _______,_______,_______,KC_QUES,KC_SLSH,_______,
